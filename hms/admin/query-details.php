...
<head>
	<title>Admin | Detalles consulta</title>
			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<div class="container-fluid container-fullw bg-white">
						...
						<div class="row">
							<div class="col-md-12">
								<h5 class="over-title margin-bottom-15">Administrar <span class="text-bold">Detalles consulta/span></h5>
													...
													<tr>
														...
														<td>
															<button type="submit" class="btn btn-primary pull-left" name="update">
																Ultima actualizacion <i class="fa fa-arrow-circle-right"></i>
															</button>
